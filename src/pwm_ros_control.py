...
class JoyToPWM:
    def __init__(self):
        ...
        right_top_thruster_idx = 0
        left_top_thruster_idx = 3
        right_bot_thruster_idx = 4
        left_bot_thruster_idx = 7

        front_right_servo_idx = 8
        front_left_servo_idx = 11
        back_right_servo_idx = 12
        back_left_servo_idx = 15
        ...
        self.kit.servo[right_top_thruster_idx].fraction = 0.6
        ...
        self.thruster_cmd_sub = rospy.Subscriber()
